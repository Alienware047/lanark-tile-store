        ...
        <div className="p-6 flex flex-col h-full">
          ...
          {cart.length > 0 ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center px-4 py-16">
              <ShoppingCart className="w-16 h-16 text-[var(--color-muted-foreground)] mb-6" />
              ...
              <Link
                href="/shop"
                onClick={toggleCart}
                className="inline-block px-6 py-3 rounded-lg bg-[var(--color-primary)] text-[var(--color-primary-foreground)] hover:bg-[var(--primary-hover)] font-semibold transition"
              >
                Browse Products
              </Link>
            </div>
