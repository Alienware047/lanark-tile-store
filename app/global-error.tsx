...
// ── Pulsing error border ─────────────────────────────────────────────────────
const pulseKeyframes = `
@keyframes borderPulse {
  0%, 100% { box-shadow: 0 0 0 0 rgba(192, 103, 30, 0); border-color: rgba(192,103,30,0.3); }
...
export default function GlobalError({
  ...
  useEffect(() => {
    // Log to your error service if needed
      ...
      <body style={{ margin: 0, padding: 0 }}>
        <div style={{
          ...
          <div style={{
            ...
            background: "radial-gradient(ellipse, rgba(192,60,30,0.09) 0%, transparent 70%)",
          ...
          <div style={{ position: "absolute", top: 0, left: 0, opacity: 0.1 }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 48px)", gap: 2 }}>
              {Array.from({ length: 8 }).map((_, i) => (
                <DecorTile key={i} size={48} seed={i * 7} tileStyle={["square", "cross", "corner", "diamond"][i % 4] as "square"} />
              ))}
            </div>
          </div>
          <div style={{ position: "absolute", bottom: 0, right: 0, opacity: 0.1 }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 48px)", gap: 2 }}>
              {Array.from({ length: 8 }).map((_, i) => (
                <DecorTile key={i} size={48} seed={i * 11 + 33} tileStyle={["diamond", "corner", "square", "cross"][i % 4] as "square"} />
              ))}
            </div>
          </div>
          ...
          >
            ...
            <div style={{ display: "flex", gap: 4, alignItems: "center", width: "100%" }}>
              <div style={{ flex: 1, height: 1, background: "rgba(192,103,30,0.15)" }} />
            ...
            {error.digest && (
              <div style={{
                ...
                border: "1px solid rgba(192,103,30,0.15)",
                borderRadius: 2, padding: "10px 14px",
                animation: "fadeInUp 0.6s 0.5s ease both",
              }}>
                <p style={{ margin: 0, fontSize: 10, letterSpacing: "0.12em", color: "#475569", textTransform: "uppercase" }}>
                  Error Reference
                </p>
            ...
            <div style={{
              ...
              <a
                ...
                style={{
                  ...
                  border: "1px solid rgba(192,103,30,0.25)",
                  fontFamily: "Georgia, serif",
                }}
              >
                Return Home
            ...
            <p style={{
              ...
              color: "#1e293b", letterSpacing: "0.12em", textTransform: "uppercase",
            }}>
